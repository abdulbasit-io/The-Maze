...
/**
 * draw_player - draws the player to the screen
 * @sdl: sdl instance of game
 * @player:player data structure
 * Return: nothing
 */
void draw_player(game_instance *sdl, player *player)
{
	REND_YELLOW(sdl->renderer);
 ...
 * @player: player data
 * @mouse: mouse with x, y coordinates
 * Return: nothing
 */
 ...
 * @player: pointer to player information
 * Return: nothing
 */
